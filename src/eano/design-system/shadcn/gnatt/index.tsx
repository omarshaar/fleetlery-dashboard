...
import { Card } from '@/eano/design-system/shadcn/card';
import {
  ContextMenu,
  ContextMenuContent,
  ContextMenuItem,
...
export const GanttProvider: FC<GanttProviderProps> = ({
  ...
  return (
    ...
    >
      <div
        className={cn(
          'gantt relative grid h-full flex-none select-none overflow-auto rounded-sm bg-secondary w-full',
          range,
          className
        )}
        ref={scrollRef}
...
export const GanttTimeline: FC<GanttTimelineProps> = ({
  ...
  <div
    className={cn(
      'relative flex h-full w-max flex-none',
      className
    )}
  >
    {children}
