...
export function buildRecentOrdersColumns(
  t: TFunction,
): ColumnConfig<EcommerceOrder>[] {
  return [
    {
      key: "orderId",
      label: t("ecommerce.dashboard.table.orders.columns.orderId"),
      type: "text",
      sortable: true,
    },
    {
      key: "customer",
      label: t("ecommerce.dashboard.table.orders.columns.customer"),
      type: "text",
      sortable: true,
    },
    {
      key: "date",
      label: t("ecommerce.dashboard.table.orders.columns.date"),
      type: "date",
    },
    {
      key: "total",
      label: t("ecommerce.dashboard.table.orders.columns.total"),
      type: "text",
    },
    {
      key: "status",
      label: t("ecommerce.dashboard.table.orders.columns.status"),
      type: "badge",
      render: (value) => {
    ...
    {
      key: "paymentMethod",
      label: t("ecommerce.dashboard.table.orders.columns.payment"),
      type: "text",
    },
  ];
}
